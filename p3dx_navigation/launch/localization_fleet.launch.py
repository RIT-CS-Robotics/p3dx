...
def generate_launch_description():
    ...
    # default initial pose is inside room 3405
    initial_pose_x = LaunchConfiguration("initial_pose_x", default="48.0")
    initial_pose_y = LaunchConfiguration("initial_pose_y", default="87.0")
    ...
    map_yaml_file = LaunchConfiguration(
        "map_yaml_file", default=["/home/robofleet/ros2_ws/src/robofleet_core/map/golisano3hi.yaml"]
    )
